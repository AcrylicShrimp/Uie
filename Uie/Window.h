...
#define WM_UIE_CONTEXT_CREAT								(0x8001)
#define WM_UIE_CONTEXT_DESTROY								(0x8002)
#define WM_UIE_OPENGL_CONTEXT_CREAT							(0x8003)
...
namespace Uie
{
	...
	public:
		...
		bool createContext(BYTE nColorBit, BYTE nDepthBit, PixelBufferProperties eNewPixelBufferProperties, PixelBufferPixelType eNewPixelBufferPixelType);
		...
		bool linkCurrentThread(HGLRC hRenderingContext) const;
